...
export default class NewCommitteeMemberWebPart extends BaseClientSideWebPart<INewCommitteeMemberWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<INewCommitteeMemberProps> = React.createElement(
      NewCommitteeMember,
      {
