...
export default class NewCommitteeMember extends React.Component<INewCommitteeMemberProps, {}> {
  public render(): React.ReactElement<INewCommitteeMemberProps> {
    ...
    return (
      <section className={`${styles.newCommitteeMember} ${hasTeamsContext ? styles.teams : ''}`}>
